...
train_loader, validate_loader, test_loader = functions_train.load_data(data_dir)
# def load_data(data_dir = 'flowers'):

model, optimizer, criterion = functions_train.build_model(arch, middle_features, lr, use)
...
functions_train.save_checkpoint(model, arch, path, middle_features, lr, epochs)
# def save_checkpoint(model, arch = 'vgg16', path = 'checkpoint.pth', middle_features = 1024, lr = 0.01, epochs = 10):
